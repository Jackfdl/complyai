...
**RAG libreria clausole** ✅ (10 lug 2026): confronto semantico per-clausola con libreria curata di formulazioni standard/rischiose — pgvector + mistral-embed, regole pure testate, degradazione totale senza config (D21, SQL §12). **Prossimo blocco di Fase 3: ruoli e approvazioni** (decisione di modello dati da prendere con l'utente: account singoli vs organizzazioni multi-utente).
