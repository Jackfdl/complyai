...
const it = {
  ...
  refTitle: "Confronto con la libreria di riferimento",
  refStandard: "≈ in linea con una formulazione standard",
  refRisky: "≈ simile a una formulazione a rischio nota",
  refSimilarity: "somiglianza",
  refHint: "Confronto semantico automatico (beta): usalo come spunto, fa fede il testo del contratto.",
...
const en: ContractsUi = {
  ...
  refTitle: "Comparison with the reference library",
  refStandard: "≈ in line with a standard wording",
  refRisky: "≈ similar to a known risky wording",
  refSimilarity: "similarity",
  refHint: "Automatic semantic comparison (beta): treat it as a hint — the contract text prevails.",
